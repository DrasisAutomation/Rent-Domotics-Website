// button-control.js - UI Button and Modal Logic (Updated with Dimmer and Lock Support)
...
function openLockConfig() {
    // Ensure lock modal exists
    if (!lockConfigModal) {
        console.error("Lock config modal not found!");
        return;
    }
...
function initializeUI() {
    ...
    // Save/Export button
    if (saveDashboardBtn) {
        saveDashboardBtn.addEventListener('click', window.saveDashboard);
    }
